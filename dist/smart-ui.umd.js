(function(global, factory) {
    ...
    setup(props2, {
      ...
      return () => vue.createVNode("button", {
        "class": `
          ...
          cursor-pointer
          border-1
          border-${props2.plain ? "solid" : "none"}
          text-${props2.plain ? props2.color + "-500" : "white"}
          text-${size[props2.size].text}
          hover:text-white
          transition duration-100 ease-in-out transform hover:scale-101
          mx-1
          `
  ...
  const JSXButton = vue.defineComponent({
    name: "JSXButton",
    render() {
      return vue.createVNode("button", null, [vue.createTextVNode("JSX Buttonn")]);
    }
  });
  const entry = {
    install: (app) => {
